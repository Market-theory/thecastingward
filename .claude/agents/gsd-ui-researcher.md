...
Use template from `/home/user/thecastingward/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/thecastingward/.claude/gsd-core/templates/UI-SPEC.md`
