...
Reference full template: `/home/user/thecastingward/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/thecastingward/.claude/gsd-core/templates/state.md`.
