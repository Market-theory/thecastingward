...
<reference>
@/home/user/thecastingward/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/thecastingward/.claude/gsd-core/references/user-profiling.md` to load:
