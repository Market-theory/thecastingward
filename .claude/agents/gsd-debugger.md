...
<required_reading>
@/home/user/thecastingward/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/thecastingward/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/thecastingward/.claude
                  → checks /home/user/thecastingward/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/thecastingward/.claude/gsd-core
                  → writes to /home/user/thecastingward/.claude/gsd-core/hooks/
...
@/home/user/thecastingward/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/thecastingward/.claude/gsd-core/references/common-bug-patterns.md
