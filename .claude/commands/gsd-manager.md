...
<execution_context>
@/home/user/thecastingward/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/thecastingward/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
