...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/thecastingward/.claude/.gsd-surface.json`
(sibling to `/home/user/thecastingward/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/thecastingward/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/thecastingward/.claude/skills`).
...
`/home/user/thecastingward/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/thecastingward/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/thecastingward/.claude/.gsd-surface.json`
Install profile marker: `/home/user/thecastingward/.claude/.gsd-profile`
Skill dirs: `/home/user/thecastingward/.claude/skills/gsd-*/`
Engine module: `/home/user/thecastingward/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/thecastingward/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
