...
```
Agent(
  prompt="Read /home/user/thecastingward/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/thecastingward/.claude/gsd-core/templates/SECURITY.md`
