...
```markdown
Read /home/user/thecastingward/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/thecastingward/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/thecastingward/.claude/agents/gsd-ui-checker.md for instructions.
