...
@/home/user/thecastingward/.claude/gsd-core/references/git-integration.md
</required_reading>
...
See `/home/user/thecastingward/.claude/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/user/thecastingward/.claude/gsd-core/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/user/thecastingward/.claude/gsd-core/templates/summary.md`.
