...
INSTALL_JS_GLOBAL="/home/user/thecastingward/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/thecastingward/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
